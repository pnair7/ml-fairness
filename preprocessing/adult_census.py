...
h = ['age', 'workclass', 'fnlwgt', 'education', 'years-of-education', 'marital-status', 'occupation',
     'relationship', 'race', 'sex', 'capital-gain', 'capital-loss', 'hours-per-week', 'native-country', 'Salary']
data = pd.read_csv('../rawDatasets/adult_census_data.txt', names=h)
data = pd.get_dummies(data, columns=['marital-status', 'workclass', 'education',
...
config = {
    ...
    'data_path': 'rawDatasets/adult_census_data.txt',
