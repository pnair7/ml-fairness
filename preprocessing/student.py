...
data = pd.read_csv('C:/Users/Daniel Tong/Desktop/school stuff/DSC/DSC 180B/ml-fairness/rawDatasets/student-mat.csv', sep=';')
data.drop(columns=['famsize', 'reason', 'guardian', 'nursery', 'romantic', 'G2', 'G3'], inplace=True)
data = pd.get_dummies(data, columns=['school', 'sex', 'address', 'address', 'Pstatus', 'Mjob', 'Fjob', 'schoolsup', 'famsup', 'paid', 'activities', 'higher', 'internet'])
...
path = 'C:/Users/Daniel Tong/Desktop/school stuff/DSC/DSC 180B/ml-fairness/cleanedDatasets/student'
try: 
    os.mkdir(path) 
